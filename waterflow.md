...
### Таблица: `cashback_offer`
| id | cashback_type | source_name | description | value_type | value | conditions |
|----|---|---|---|---|---|---|
| 1 | cashback-service | backit.me | маркетплейс AliExpress и более 800 магазинов | percent | до 81% Товары из раздела Специальные предложения; 0.6%-6% Аффилиатные товары; 0% Неаффилиатные товары российских продавцов; 0.12% Неаффилиатные товары зарубежных продавцов | макс кэшбек: 1500₽ за 1 заказ; 500₽ за 1 товар; не работает: а. на доставку;б. вирт.товары/услуги; сертификаты; моб.связь |
| 2 | bank | ubrr.ru MyLife+ v01.08.25 | Покупки картой онлайн/приложение | percent | 10 | 1. оборот ₽5000+/мес 2. до ₽600/мес 3. подписка ₽299/мес 4. округление вниз кратно ₽100 5. выплата до 20 числа к.мес. |
| 3 | bank | ubrr.ru MyLife | Покупки картой онлайн/приложение | percent | 1 | оборот ₽5000+/мес; выбрать категорию до оплаты; 3-5 дней обработка транзакции; 20 числа выплата |
| 4 | bank | finance.ozon | Покупки картой онлайн/приложение | percent | 1 | выбрать категорию до оплаты; 3-5 дней обработка транзакции; 20 числа выплата |
| 5 | bank | vtb | Покупки картой онлайн/приложение | percent | 1 | выбрать категорию до оплаты; 3-5 дней обработка транзакции; 20 числа выплата |
| 6 | bank | sber | Покупки картой онлайн/приложение | percent | 0.5 | зачисление до 5-14 дней, категорию выбирать с 1 числа |
| 7 | bank | Альфа Банк | Покупки картой онлайн/приложение | percent | 1 | выбрать категорию до оплаты; 3-5 дней обработка транзакции; 20 числа выплата; оплата альфа-картой |
| 8 | bank | sovkom | Покупки картой онлайн/приложение | percent | 2 | безусловный |
| 9 | bank | gpb.ru | Покупки картой онлайн/приложение | percent | 2 | «Понятный»; максимум ₽3000 |

---

## Инфраструктура и Сервисы

Этот раздел описывает внешние сервисы, учетные записи и доступы, которые используются в системе.
...
#### Таблица: `order_item`
| id | order_id (FK) | catalog_id (FK) | qty | price_per_item | subtotal | cost_of_goods_sold | sale_price | discount_amount | discount_description |
|----|---------------|-----------------|-----|----------------|----------|--------------------|------------|-----------------|----------------------|
