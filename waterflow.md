...
| id | source_type | source_name | marketplace | value_type | value | conditions |
|---|---|---|---|---|---|---|
| 1 | service | backit.me | маркетплейс AliExpress и более 800 магазинов | percent | до 81% Товары из раздела Специальные предложения; 0.6%-6% Аффилиатные товары; 0% Неаффилиатные товары российских продавцов; 0.12% Неаффилиатные товары зарубежных продавцов | макс кэшбек: 1500₽ за 1 заказ; 500₽ за 1 товар; не работает: а. на доставку;б. вирт.товары/услуги; сертификаты; моб.связь |
...
| 3 | bank | ubrr.ru MyLife | Покупки картой онлайн/приложение | percent | 1 | выбрать категорию до оплаты; 3-5 дней обработка транзакции; 20 числа выплата |
